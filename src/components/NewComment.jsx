...
export default function NewComment({article_id, setComments}){
    ...
    return (
        <form onSubmit={handleSubmit} className="min-w-full px-6 py-14 mx-auto mb-4 bg-slate-100 border-solid border-b-2">
            ...
            <button type="submit" className="text-white mx-auto mt-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        </form>
    )
}